...
class MyCardiology extends StatefulWidget {
  const MyCardiology({super.key});

  @override
  State<MyCardiology> createState() => _MyCardiologyState();
}

class _MyCardiologyState extends State<MyCardiology> {
        ...
        actions: [
          QuickAction(
            ...
            onTap: () async {
              ...
              if (selectedImage1 != null) {
                bool success = await uploadFileCar(selectedImage1);
                if (success) {
          ...
          QuickAction(
            ...
            onTap: () async {
              ...
              if (selectedImage != null) {
                bool success = await uploadFileCar(selectedImage);
                if (success) {
                  await getUploadedFiles();
                }
              }
          ...
          QuickAction(
            ...
            onTap: () async {
              ...
              if (pickedFile != null) {
                bool uploadSuccess = await uploadFileCar(pickedFile);
                if (uploadSuccess) {
  ...
  Future<void> getUploadedFiles() async {
    List<Reference>? result = await getUsersUploadedFilesCar();
    if (result != null) {
      setState(() {
