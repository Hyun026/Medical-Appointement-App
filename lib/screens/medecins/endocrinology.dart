...
class MyEndocrinology extends StatefulWidget {
  const MyEndocrinology({super.key});

  @override
  State<MyEndocrinology> createState() => _MyEndocrinologyState();
}

class _MyEndocrinologyState extends State<MyEndocrinology> {
        ...
        actions: [
          QuickAction(
            ...
            onTap: () async {
              ...
              if (selectedImage1 != null) {
                bool success = await uploadFileEndoc(selectedImage1);
                if (success) {
          ...
          QuickAction(
            ...
            onTap: () async {
              ...
              if (selectedImage != null) {
                bool success = await uploadFileEndoc(selectedImage);
                if (success) {
                  await getUploadedFiles();
                }
              }
          ...
          QuickAction(
            ...
            onTap: () async {
              ...
              if (pickedFile != null) {
                bool uploadSuccess = await uploadFileEndoc(pickedFile);
                if (uploadSuccess) {
  ...
  Future<void> getUploadedFiles() async {
    List<Reference>? result = await getUsersUploadedFilesEndoc();
    if (result != null) {
      setState(() {
