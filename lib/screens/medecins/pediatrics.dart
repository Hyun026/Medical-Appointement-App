...
class MyPediatricy extends StatefulWidget {
  const MyPediatricy({super.key});

  @override
  State<MyPediatricy> createState() => _MyPediatricyState();
}

class _MyPediatricyState extends State<MyPediatricy> {
        ...
        actions: [
          QuickAction(
            ...
            onTap: () async {
              ...
              if (selectedImage1 != null) {
                bool success = await uploadFilePedia(selectedImage1);
                if (success) {
          ...
          QuickAction(
            ...
            onTap: () async {
              ...
              if (selectedImage != null) {
                bool success = await uploadFilePedia(selectedImage);
                if (success) {
                  await getUploadedFiles();
                }
              }
          ...
          QuickAction(
            ...
            onTap: () async {
              ...
              if (pickedFile != null) {
                bool uploadSuccess = await uploadFilePedia(pickedFile);
                if (uploadSuccess) {
  ...
  Future<void> getUploadedFiles() async {
    List<Reference>? result = await getUsersUploadedFilesPedia();
    if (result != null) {
      setState(() {
