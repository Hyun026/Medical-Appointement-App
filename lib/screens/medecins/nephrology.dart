...
class MyNephro extends StatefulWidget {
  const MyNephro({super.key});

  @override
  State<MyNephro> createState() => _MyNephroState();
}

class _MyNephroState extends State<MyNephro> {
          ...
          QuickAction(
            ...
            onTap: () async {
              ...
              if (selectedImage1 != null) {
                bool success = await uploadFileNeph(selectedImage1);
                if (success) {
          ...
          QuickAction(
            ...
            onTap: () async {
              ...
              if (selectedImage != null) {
                bool success = await uploadFileNeph(selectedImage);
                if (success) {
                  await getUploadedFiles();
                }
              }
  ...
  Future<void> getUploadedFiles() async {
    List<Reference>? result = await getUsersUploadedFilesNeph();
    if (result != null) {
      setState(() {
