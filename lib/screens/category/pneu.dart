...
class Pneumo extends StatefulWidget {
  const Pneumo({super.key});

  @override
  State<Pneumo> createState() => _PneumoState();
}

class _PneumoState extends State<Pneumo> {
  final FirebaseFirestore _firestore = FirebaseFirestore.instance;

  Future<List<Map<String, dynamic>>> _getPediatricians() async {
    QuerySnapshot querySnapshot = await _firestore
        .collection('doctors')
        .where('field', isEqualTo: 'Pneumologie')
        .get();
