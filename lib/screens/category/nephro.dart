...
class Nephrolo extends StatefulWidget {
  const Nephrolo({super.key});

  @override
  State<Nephrolo> createState() => _NephroloState();
}

class _NephroloState extends State<Nephrolo> {
  final FirebaseFirestore _firestore = FirebaseFirestore.instance;

  Future<List<Map<String, dynamic>>> _getPediatricians() async {
    QuerySnapshot querySnapshot = await _firestore
        .collection('doctors')
        .where('field', isEqualTo: 'Nephrologist')
        .get();
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Center(child: Text('No Nephrologist found'));
          } else {
