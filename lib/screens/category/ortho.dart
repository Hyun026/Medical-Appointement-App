...
class Orthope extends StatefulWidget {
  const Orthope({super.key});

  @override
  State<Orthope> createState() => _OrthopeState();
}

class _OrthopeState extends State<Orthope> {
  final FirebaseFirestore _firestore = FirebaseFirestore.instance;

  Future<List<Map<String, dynamic>>> _getPediatricians() async {
    QuerySnapshot querySnapshot = await _firestore
        .collection('doctors')
        .where('field', isEqualTo: 'Orthipedy')
        .get();
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Center(child: Text('No Orthepidy found'));
          } else {
