...
class PatientFilesScreenPath extends StatefulWidget {
  final String patientId;

  PatientFilesScreenPath({required this.patientId});

  @override
  _PatientFilesScreenPathState createState() => _PatientFilesScreenPathState();
}

class _PatientFilesScreenPathState extends State<PatientFilesScreenPath> {
  ...
  Future<List<Reference>> listPatientFiles(String userId) async {
    final storageRef = FirebaseStorage.instance.ref().child("$userId/medFiles/pathology");
  ...
  Future<bool> uploadFileCar(File file) async {
    try {
      final storageRef = FirebaseStorage.instance.ref().child("${widget.patientId}/medFiles/pathology/${file.path.split('/').last}");
