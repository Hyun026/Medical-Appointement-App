...
class PatientFilesScreenOpht extends StatefulWidget {
  final String patientId;

  PatientFilesScreenOpht({required this.patientId});

  @override
  _PatientFilesScreenOphtState createState() => _PatientFilesScreenOphtState();
}

class _PatientFilesScreenOphtState extends State<PatientFilesScreenOpht> {
  ...
  Future<List<Reference>> listPatientFiles(String userId) async {
    final storageRef = FirebaseStorage.instance.ref().child("$userId/medFiles/ophtalmology");
  ...
  Future<bool> uploadFileCar(File file) async {
    try {
      final storageRef = FirebaseStorage.instance.ref().child("${widget.patientId}/medFiles/ophtalmology/${file.path.split('/').last}");
