...
class PatientFilesScreenEndo extends StatefulWidget {
  final String patientId;

  PatientFilesScreenEndo({required this.patientId});

  @override
  _PatientFilesScreenEndoState createState() => _PatientFilesScreenEndoState();
}

class _PatientFilesScreenEndoState extends State<PatientFilesScreenEndo> {
  ...
  Future<List<Reference>> listPatientFiles(String userId) async {
    final storageRef = FirebaseStorage.instance.ref().child("$userId/medFiles/endocrinology");
  ...
  Future<bool> uploadFileCar(File file) async {
    try {
      final storageRef = FirebaseStorage.instance.ref().child("${widget.patientId}/medFiles/endocrinology/${file.path.split('/').last}");
