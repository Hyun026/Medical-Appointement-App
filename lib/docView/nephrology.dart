...
class PatientFilesScreenNeph extends StatefulWidget {
  final String patientId;

  PatientFilesScreenNeph({required this.patientId});

  @override
  _PatientFilesScreenNephState createState() => _PatientFilesScreenNephState();
}

class _PatientFilesScreenNephState extends State<PatientFilesScreenNeph> {
  ...
  Future<List<Reference>> listPatientFiles(String userId) async {
    final storageRef = FirebaseStorage.instance.ref().child("$userId/medFiles/nephrology");
  ...
  Future<bool> uploadFileCar(File file) async {
    try {
      final storageRef = FirebaseStorage.instance.ref().child("${widget.patientId}/medFiles/nephrology/${file.path.split('/').last}");
