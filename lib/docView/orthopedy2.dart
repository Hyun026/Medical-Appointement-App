...
class PatientFilesScreenOrth extends StatefulWidget {
  final String patientId;

  PatientFilesScreenOrth({required this.patientId});

  @override
  _PatientFilesScreenOrthState createState() => _PatientFilesScreenOrthState();
}

class _PatientFilesScreenOrthState extends State<PatientFilesScreenOrth> {
  ...
  Future<List<Reference>> listPatientFiles(String userId) async {
    final storageRef = FirebaseStorage.instance.ref().child("$userId/medFiles/orthopedy");
  ...
  Future<bool> uploadFileCar(File file) async {
    try {
      final storageRef = FirebaseStorage.instance.ref().child("${widget.patientId}/medFiles/orthopedy/${file.path.split('/').last}");
