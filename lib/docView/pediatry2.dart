...
class PatientFilesScreenPe extends StatefulWidget {
  final String patientId;

  PatientFilesScreenPe({required this.patientId});

  @override
  _PatientFilesScreenPeState createState() => _PatientFilesScreenPeState();
}

class _PatientFilesScreenPeState extends State<PatientFilesScreenPe> {
  ...
  Future<List<Reference>> listPatientFiles(String userId) async {
    final storageRef = FirebaseStorage.instance.ref().child("$userId/medFiles/pediatricts");
  ...
  Future<bool> uploadFileCar(File file) async {
    try {
      final storageRef = FirebaseStorage.instance.ref().child("${widget.patientId}/medFiles/pediatricts/${file.path.split('/').last}");
