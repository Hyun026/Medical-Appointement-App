...
class PatientFilesScreenPneu extends StatefulWidget {
  final String patientId;

  PatientFilesScreenPneu({required this.patientId});

  @override
  _PatientFilesScreenPneuState createState() => _PatientFilesScreenPneuState();
}

class _PatientFilesScreenPneuState extends State<PatientFilesScreenPneu> {
  ...
  Future<List<Reference>> listPatientFiles(String userId) async {
    final storageRef = FirebaseStorage.instance.ref().child("$userId/medFiles/pneumology");
  ...
  Future<bool> uploadFileCar(File file) async {
    try {
      final storageRef = FirebaseStorage.instance.ref().child("${widget.patientId}/medFiles/pneumology/${file.path.split('/').last}");
